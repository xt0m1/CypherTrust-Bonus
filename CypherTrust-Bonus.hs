...
parseVtx :: IO Vstack
parseVtx = do
  csv <- BL.readFile "2022Q4_TRUST_token_holders_snapshot-ethOnly.csv"
...
wHeader :: IO ()
wHeader = BL.writeFile "TRUST-Holders-Bonus-2022Q4.csv"
  "address,address_type,balance,bonus,annonation\n"

writeData :: Vtx -> IO ()
writeData x = BL.appendFile "TRUST-Holders-Bonus-2022Q4.csv" (bytes x)
